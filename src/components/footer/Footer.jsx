  ...
  return (
    <footer className="bg-gray-900 text-gray-200 py-8 mt-12">
      <div className="flex flex-col md:flex-row items-center justify-between px-6 gap-4">
        <div className="text-lg font-semibold">&copy; {new Date().getFullYear()} Inspire Interiors. All rights reserved.</div>
        <div className="flex gap-4">
          ...
          <a href="#" aria-label="Pinterest" className="hover:text-indigo-400 transition-colors">
